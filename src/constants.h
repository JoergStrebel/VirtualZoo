...
namespace Constants
{
    ...
    constexpr double UNLIMITEDSIGHTDISTANCE = -1.0; //use negative value for unlimited sight distance
    constexpr int ANGULAR_RESOLUTION = 100;  // 1D screen resolution: 100 angular pixels
